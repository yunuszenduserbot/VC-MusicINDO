...
class Messages():
      ...
      HELP_MSG = [
        ".",
f"""
**Hy lagi kamu bertemu lagi dengan saya Zend Project

⚪️ Zend Project bisa memutar musik baik itu di VC Group atau VC Channel

⚪️ Nama Asisten >> [Zend Assisten](https://t.me/ZendMusic)\n\nKlik tombol dibawah untuk melihat intruksi lain**
◎› Owner Bot >> [Yunus Zend](https://t.me/ZendYNS)
◎› Bot Musik >> [Zend Bot](https://t.me/ZendMusic_Bot)
""",
...
*) Jika userbot bergabung nikmati musik, Jika tidak tambahkan @ZendMusic ke grup Anda dan coba lagi
...
4) Tambahkan @ZendMusic ke saluran sebagai admin.
...
• /userbotjoin: Undang @ZendMusic Userbot ke obrolan Anda
